...
**작성일:** 2026-05-28
**관련 페이지:** [[문제-해결/ki-ai-trader-미해결-이슈-20260528]], [[개념/telegram-이상징후-판단기준-20260528]], [[개념/telegram-이상징후-검증-20260528]]
...
| 문서 | 경로 | 설명 |
|:----|:----|:-----|
| [[개념/telegram-이상징후-판단기준-20260528]] | `개념/` | 7개 이상징후를 정상/경고/장애로 구분하는 기준 |
| [[개념/telegram-이상징후-검증-20260528]] | `개념/` | 7개 항목 실시간 검증 결과 |
| [[문제-해결/ki-ai-trader-미해결-이슈-20260528]] | `문제-해결/` | 미해결 이슈 현황 (P0~P3 우선순위) |
