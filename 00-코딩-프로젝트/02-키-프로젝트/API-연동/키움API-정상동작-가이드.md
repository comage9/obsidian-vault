...
> 최종 갱신: 2026-04-24 | PDF 문서 기준

## 현재 상태 (Compiled Truth)

### 계좌
- 계좌번호: 5206921810
- HMM(011200): 10주 | 21,200원 | +1.69%
- 대창단조(012800): 69주 | 1,497원 | -0.28%
- 예수금: 31,413원
- 총자산: 346,037원
...
### ⚠️ 주문 API 매수/매도 구분 (핵심!)
| 기능 | api-id | 설명 |
|------|--------|------|
| **매수주문** | **kt10000** | 주식 매수주문 |
| **매도주문** | **kt10001** | 주식 매도주문 |
| 정정주문 | kt10002 | 주식 정정주문 |
| 취소주문 | kt10003 | 주식 취소주문 |

> **주의**: 기존 코드에서 BUY/SELL 모두 kt10001 사용 → 매수 시 에러 발생. 반드시 매수는 kt10000 사용!
...
| **매수주문** | **kt10000** | /api/dostk/ordr |
| 매도주문 | kt10001 | /api/dostk/ordr |

---
## 변경 이력 (Timeline)
- 2026-04-24: 매수/매도 API 구분 정정 (kt10000 vs kt10001), 계좌 현황 업데이트
